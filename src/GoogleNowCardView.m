...
- (void)setPrimaryText:(NSString *)primaryText
{
    ...
    [self.primaryTextLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:PRIMARY_TEXT_TEXT_SIZE]];
}
...
- (void)setSubtitleText:(NSString *)subtitleText
{
    ...
    [self.subtitleTextLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:SUBTEXT_TEXT_SIZE]];
}
...
- (void)setAction1Text:(NSString *)action1Text
{
    ...
    [self.action1Button.titleLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:PRIMARY_TEXT_TEXT_SIZE]];
}
...
- (void)setAction2Text:(NSString *)action1Text
{
    ...
    [self.action2Button.titleLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:PRIMARY_TEXT_TEXT_SIZE]];
}
...
- (void)setFrame:(CGRect)frame
{
    ...
    UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRoundedRect:self.bounds cornerRadius:ROUNDED_CORNER_RADIUS];
...
- (void)layoutPrimaryTextLabel
{
    ...
    CGSize expectedLabelSize = [self.primaryText
                                sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"Roboto-Light" size:PRIMARY_TEXT_TEXT_SIZE]}];
    
    self.primaryTextLabel.frame = CGRectMake(x, y, width, expectedLabelSize.height);
}

- (void)layoutSubtitleTextLabel
{
    CGFloat x = TEXT_LEFT_RIGHT_PADDING;
    CGFloat y = PRIMARY_TEXT_TOP_PADDING + _primaryTextLabel.frame.size.height + SUBTITLE_TOP_PADDING;
    CGFloat width = self.frame.size.width - 2 * TEXT_LEFT_RIGHT_PADDING;
...
- (void)layoutActionButton1
{
    ...
    //CGFloat y = PRIMARY_TEXT_TOP_PADDING + _primaryTextLabel.frame.size.height + SUBTITLE_TOP_PADDING + _subtitleTextLabel.frame.size.height + SUBTEXT_BOTTOM_PADDING + ACTIONS_PADDING;
    CGFloat y = PRIMARY_TEXT_TOP_PADDING;
    ...
    [self.action1Button setBackgroundImage:[UIImage imageNamed:@"favorite-clicked"]
